...
def main():
    ...
    log_file_path = os.path.join(base_path, "2. log", "P0answerTestCase.log")
    ...
    with requests.Session() as session:
        ...
        csv_path = os.path.join(
            base_path, "4. answerAndQuestion", "P0answerTestCase.csv"
        )
        ...
        for _, row in df.iterrows():
            ...
            # Now it will print the case_id and status regardless of success or failure
