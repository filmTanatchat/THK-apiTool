...
def main():
    ...
    # Now, read the newly created CSV and save it as JSON
    new_df = pd.read_csv(csv_output, dtype=str)
    save_as_json(new_df, json_output)


if __name__ == "__main__":
    current_script_path = os.path.dirname(os.path.realpath(__file__))
    BASE_PATH = os.path.dirname(current_script_path)
    CSV_PATH = os.path.join(BASE_PATH, "4. answerAndQuestion", "questionAllFields.csv")
    main()
